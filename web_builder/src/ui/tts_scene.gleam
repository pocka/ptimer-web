...
@external(javascript, "@/ui/tts_scene.ffi.ts", "playAudioEl")
...
@external(javascript, "@/ui/tts_scene.ffi.ts", "stopAudioEl")
...
@external(javascript, "@/ui/tts_scene.ffi.ts", "className")
