...
import builder/ui/menu
import builder/ui/metadata_editor
import builder/ui/placeholder
import builder/ui/steps_editor
import builder/ui/tts_scene
import gleam/dict
...
@external(javascript, "@/builder/app.ffi.ts", "openFilePicker")
fn open_file_picker(
  accept: String,
...
@external(javascript, "@/builder/app.ffi.ts", "raf")
fn request_animation_frame(callback: fn() -> Nil) -> Nil

@external(javascript, "@/builder/app.ffi.ts", "tryFocus")
...
@external(javascript, "@/builder/app.ffi.ts", "className")
