...
@external(javascript, "@/builder/ui/int_input.ffi.ts", "overwriteValue")
...
@external(javascript, "@/builder/ui/int_input.ffi.ts", "textboxClassName")
fn scoped_textbox(x: String) -> String

@external(javascript, "@/builder/ui/int_input.ffi.ts", "className")
