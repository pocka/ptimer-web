...
@external(javascript, "@/builder/tts.ffi.ts", "newTTSEngine")
...
@external(javascript, "@/builder/tts.ffi.ts", "getPredefinedVoices")
...
@external(javascript, "@/builder/tts.ffi.ts", "run")
fn run_internal(
  tts: dynamic.Dynamic,
  text: String,
  voice_key: String,
